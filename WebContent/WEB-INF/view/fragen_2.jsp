		...
		<div class="col-sm-12">
			<nav class="navbar-expand-sm" aria-label="fragen300">
				...
				<ul class="pagination pagination-sm justify-content-center">
					<li class="page-item"><a class="page-link" href="fragen_1"
						aria-disabled="true">Previous</a></li>
					<li class="page-item" aria-current="page"><a class="page-link" 
						href="fragen_1">1 <span class="sr-only">(current)</span></a></li>
					<li class="page-item active"><a class="page-link" href="fragen_2">2 </a></li>
					...
					<li class="page-item"><a class="page-link" href="fragen_3">Next</a></li>
				</ul>
				<br />
			</nav>
		</div>
