		...
		<div class="col-sm-12">
			<nav class="navbar-expand-sm" aria-label="fragen300">
				...
				<ul class="pagination pagination-sm justify-content-center">
					<li class="page-item"><a class="page-link" href="fragen_6"
					...
					<li class="page-item active"><a class="page-link" href="fragen_7">7</a></li>
					...
					<li class="page-item"><a class="page-link" href="fragen_8">Next</a></li>
				</ul>
				<br />
			</nav>
		</div>
